...
dict_get_city = {'client':'e22c59101699ac978ee83bfb81d4c949','time':'1464340958','city_id':'2419'}
...
def get_sign(dict_get_city,secret):

    sourt_dict = sorted(dict_get_city.items(),key=lambda d:d[0])
...
def new_sign():
    dict_get_city['time'] = get_time()
    dict_get_city['sign'] = get_sign(dict_get_city,secret)
    return dict_get_city
