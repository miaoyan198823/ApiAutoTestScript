...
dict_get_cpsBill = {'client':'e22c59101699ac978ee83bfb81d4c949','time':'1464340958','page':1,'per_page':5}
...
def get_sign(dict_get_cpsBill,secret):

    sourt_dict = sorted(dict_get_cpsBill.items(),key=lambda d:d[0])
...
def new_sign():
    dict_get_cpsBill['time'] = get_time()
    dict_get_cpsBill['sign'] = get_sign(dict_get_cpsBill,secret)
    return dict_get_cpsBill
