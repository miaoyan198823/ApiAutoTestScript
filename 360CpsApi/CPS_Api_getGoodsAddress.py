...
class GetGoodsAddressApi():
    def __init__(self):
        global api_url
        global params
        global headers
        api_url = 'http://wireless.api.test.lashou.com/index4openapi.php/Openapi/Method/getGoodsAddress'
        params = getGoodsAddress_Sign.new_sign()
        headers = getGoodsAddress_Sign.get_headers()

    def test_getGoodsAddress_api(self):
        try:
